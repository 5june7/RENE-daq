...
inline void FChannel::SetLocTrgTime(unsigned long t){ fLocTrgTime = t; } // WJ
inline void FChannel::SetTCBTrgTime(unsigned long t){ fTCBTrgTime = t; } // WJ

// To get the value
inline unsigned long FChannel::GetLocTrgTime(){ return fLocTrgTime; } // WJ 
inline unsigned long FChannel::GetTCBTrgTime(){ return fTCBTrgTime; } // WJ

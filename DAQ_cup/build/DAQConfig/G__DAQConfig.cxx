...
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/AbsConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/AbsConfList.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/AmoreADCConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/DAQConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/FADCSConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/FADCTConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/GADCSConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/GADCTConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/IADCTConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/MADCSConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/SADCSConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/SADCTConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/STRGConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/TCBConf.hh"
#include "/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/TriggerLookupTable.hh"
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<tuple<int,string,string,int> >*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<tuple<int,string,string,int> >","std::vector<std::tuple<int, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, int>, std::allocator<std::tuple<int, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, int> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static void *new_vectorlEtuplelEintcOstringcOstringcOintgRsPgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<tuple<int,string,string,int> > : new vector<tuple<int,string,string,int> >;
   }
   static void *newArray_vectorlEtuplelEintcOstringcOstringcOintgRsPgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<tuple<int,string,string,int> >[nElements] : new vector<tuple<int,string,string,int> >[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEtuplelEintcOstringcOstringcOintgRsPgR(void *p) {
...
"/home/frontend/Software/root/v6.28.04/install/include/",
"/home/frontend/DAQ/DAQ_cup/build/DAQConfig/",
nullptr
    };
...
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/AbsConf.hh")))  AbsConf;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/AbsConfList.hh")))  AbsConfList;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/AmoreADCConf.hh")))  AmoreADCConf;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/DAQConf.hh")))  DAQConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/FADCTConf.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/FADCSConf.hh")))  FADCTConf;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/FADCSConf.hh")))  FADCSConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/GADCTConf.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/GADCSConf.hh")))  GADCTConf;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/GADCSConf.hh")))  GADCSConf;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/IADCTConf.hh")))  IADCTConf;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/MADCSConf.hh")))  MADCSConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/SADCTConf.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh")))  SADCTConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/SADCSConf.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh")))  SADCSConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/STRGConf.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh")))  STRGConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/TCBConf.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh")))  TCBConf;
class __attribute__((annotate("$clingAutoload$DAQConfig/TriggerLookupTable.hh")))  __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh")))  TriggerLookupTable;
class __attribute__((annotate("$clingAutoload$/home/frontend/DAQ/DAQ_cup/build/include/DAQConfig/RunConfig.hh")))  RunConfig;
)DICTFWDDCLS";

...
void SourceData_Qsum_veto_fitting(int run, int subrun){
    ...
    TF1 * f1 = new TF1("f1" , "landau", 624 ,3000);
    f1->SetParameter(0,1.62121e+01);
    f1->SetParameter(1,1.58425e+03);
    f1->SetParameter(2,4.53825e+02);
    f1->SetLineColor(4);
    h_Qsum_each[1]->Fit(f1,"R");

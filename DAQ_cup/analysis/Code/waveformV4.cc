...
void waveformV4(int run, int chan=8, bool logOnOff=0){
    ...
    TFile * inf;
    if(run<10) inf = new TFile(Form("/home/frontend/DAQ/DAQ_cup/Data/RAW/00000%d/FADC_00000%d.root.00000", run, run),"read");
    else if(run<100) inf = new TFile(Form("/home/frontend/DAQ/DAQ_cup/Data/RAW/0000%d/FADC_0000%d.root.00000", run, run),"read");
    else if(run<1000) inf = new TFile(Form("/home/frontend/DAQ/DAQ_cup/Data/RAW/000%d/FADC_000%d.root.00001", run, run),"read");
